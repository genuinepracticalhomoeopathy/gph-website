          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-7xl mx-auto">
              {blogs.map((blog, index) => (
                <article
                  key={blog.id}
                  className={`group bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-green-200 hover:-translate-y-1 ${index === 0 ? 'md:col-span-2 xl:col-span-1' : ''
                    }`}
                >
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    {/* Title */}
                    <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 group-hover:text-green-600 transition-colors duration-200 leading-tight">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-3 sm:pt-4 border-t border-gray-100 gap-3 sm:gap-0">
                      ...
                      <Link
                        href={`/blogs/${blog.id}`}
                        className="inline-flex items-center space-x-1 text-green-600 hover:text-green-700 font-medium text-sm sm:text-base group-hover:translate-x-1 transition-transform duration-200 py-2 sm:py-0"
                      >
                        <span>Read more</span>
